...
#include "my_robot_msgs/action/path_plan.hpp"
#include "geometry_msgs/msg/point.hpp"

typedef my_robot_msgs::action::PathPlan NavigateAction;
...
class NavigateActionServerNode : public rclcpp::Node
{
  public:
    ...
    {
      robot_position_ = Point();   // set robot position to 0 in x 0  in y 0 in z
